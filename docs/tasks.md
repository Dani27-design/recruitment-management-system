...
- [x] 1. Implement AuditLog database model.
  - [x] 1.1. Add `id`.
  - [x] 1.2. Add `entity_type`.
  - [x] 1.3. Add `entity_id`.
  - [x] 1.4. Add `event_type`.
  - [x] 1.5. Add `actor_id`.
  - [x] 1.6. Add `changes` as JSON.
  - [x] 1.7. Add `created_at`.
  - [x] 1.8. Model AuditLog generated by User.
  - [x] 1.9. Generate AuditLog migration.
- [x] 2. Implement audit repository.
  - [x] 2.1. Implement create audit log.
  - [x] 2.2. Implement list audit logs.
  - [x] 2.3. Implement filter audit logs by entity.
  - [x] 2.4. Implement filter audit logs by event type.
- [x] 3. Implement audit service.
  - [x] 3.1. Record audit logs for successful `CREATE` operations.
  - [x] 3.2. Record audit logs for successful `UPDATE` operations.
  - [x] 3.3. Record audit logs for successful `DELETE` operations.
  - [x] 3.4. Store actor in each audit entry.
  - [x] 3.5. Store entity type in each audit entry.
  - [x] 3.6. Store entity id in each audit entry.
  - [x] 3.7. Store event type in each audit entry.
  - [x] 3.8. Store changed fields in each audit entry.
  - [x] 3.9. Store timestamp in each audit entry.
  - [x] 3.10. Make audit logs append-only.
  - [x] 3.11. Prohibit audit log modification.
  - [x] 3.12. Prohibit audit log deletion.
- [x] 4. Integrate audit logging into write operations.
  - [x] 4.1. Integrate audit logging into candidate create, update, and delete.
  - [x] 4.2. Integrate audit logging into vacancy create, update, and delete.
  - [x] 4.3. Integrate audit logging into recruitment create.
  - [x] 4.4. Integrate audit logging into recruitment stage updates.
  - [x] 4.5. Integrate audit logging into stage assignment updates.
  - [x] 4.6. Integrate audit logging into recruitment document upload and delete.
- [x] 5. Implement audit validation.
  - [x] 5.1. Validate audit log list filters.
  - [x] 5.2. Validate entity filter input.
  - [x] 5.3. Validate event type filter input.
- [x] 6. Implement audit controller and route.
  - [x] 6.1. Implement `GET /audit-logs`.
  - [x] 6.2. Restrict audit logs to Administrator users.
- [x] 7. Implement audit frontend.
  - [x] 7.1. Create Audit Log page.
  - [x] 7.2. Create Audit Table component.
  - [x] 7.3. Create Entity Filter component.
  - [x] 7.4. Create Event Filter component.
  - [x] 7.5. Fetch audit logs.
  - [x] 7.6. Filter audit logs by entity.
  - [x] 7.7. Filter audit logs by event type.
  - [x] 7.8. Surface audit API errors.
- [x] 8. Complete Phase 9 implementation readiness.
  - [x] 8.1. Ensure CRUD operations generate audit logs.
  - [x] 8.2. Ensure change tracking is implemented.
  - [x] 8.3. Ensure audit filtering is implemented.
  - [x] 8.4. Commit Phase 9 as `feat: phase 9 audit logging`.
